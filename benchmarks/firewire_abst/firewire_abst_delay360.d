...
mode abstract_firewire (((s==0)=>(x<=360))&&((s==1)=>(x<=360))&&((s==2)=>(x<=360))&&((s==3)=>(x<=360))&&((s==4)=>(x<=360))&&((s==5)=>(x<=850))&&((s==6)=>(x<=1670))&&((s==7)=>(x<=1670))&&((s==8)=>(x<=1670))) {
/*1*/
when (s==0) may s=1;
/*2*/
when (s==0) may s=4;
...
/*14*/
when ((s==5)&&(x>=400)) may s=9;x=0;
/*15*/
when ((s==6)&&(x>=1230)) may s=9;x=0;
/*16*/
when ((s==7)&&(x>=1230)) may s=9;x=0;
/*17*/
when ((s==8)&&(x>=1590)) may s=0;x=0;
/*18*/
when ((s==8)&&(x>=1230)) may s=9;x=0;
/*19*/
when (s==9) may ;
}
